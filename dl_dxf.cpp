...
void DL_Dxf::test() {
    ...
    strcpy_s(buf1,strlen(buf1) ,"  10\n");
    strcpy_s(buf2,strlen(buf2),  "10");
    strcpy_s(buf3, strlen(buf3), "10\n");
    strcpy_s(buf4, strlen(buf4), "  10 \n");
    strcpy_s(buf5, strlen(buf5), "  10 \r");
    strcpy_s(buf6, strlen(buf6), "\t10 \n");
